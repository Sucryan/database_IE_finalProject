...
if (isset($_GET['id'])) {
    ...
    echo '無效的用戶ID';
    echo '<meta http-equiv=REFRESH CONTENT=2;url=system_manager.php>';
    exit();
}
...
<head>
    ...
    <style>
        body {
            ...
            background: url('21.jpg') no-repeat center center fixed;
...
<body>
    <div class="container">
        <div class="header">
            <h2>更新資料</h2>
            <div>
                <a href="system_manager.php">返回管理頁面</a>
                <a href="manager_logout.php">登出</a>
            </div>
        </div>

        <form method="post" action="manager_Update.php?id=<?php echo $id; ?>" onsubmit="return validateForm()">
